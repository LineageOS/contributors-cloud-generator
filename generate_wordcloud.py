...
parser.add_argument('--mirror', metavar='mirror_dir', type=str,
...
def repo_fetch(project):
    ...
    if os.path.exists(repodir):
        ...
        os.makedirs(repodir)
        if args.reference:
            call(['git', 'clone', '--no-checkout', '--reference', os.path.join(args.reference+project), 'https://github.com/'+project, project])
        else:
            call(['git', 'clone', '--no-checkout', 'https://github.com/'+project, project])
